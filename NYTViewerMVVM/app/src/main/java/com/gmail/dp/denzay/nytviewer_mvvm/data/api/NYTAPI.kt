...
interface NYTAPI {
    ...
    fun getEmailedArticles(@Path("period") period: Int, @Query("api-key") apiKey: String): Single<Response<List<MostEmailedModel>>>

    @GET("svc/mostpopular/v2/shared/{period}.json")
    fun getSharedArticles(@Path("period") period: Int, @Query("api-key") apiKey: String): Single<Response<List<MostSharedModel>>>

    @GET("svc/mostpopular/v2/viewed/{period}.json")
    fun getViewedArticles(@Path("period") period: Int, @Query("api-key") apiKey: String): Single<Response<List<MostViewedModel>>>
}
